...
**Ngày:** 2026-07-19 · **Phiên bản:** 1.2 · **Trạng thái:** Đã duyệt, đang triển khai
...
| 3 | Grading-worker | Tải file → local, FFmpeg, lớp provider LLM + rubric JSON (gồm dimension phát âm), DLQ hoạt động | 1 clip thật 5 phút được chấm end-to-end theo rubric chuẩn: điểm từng tiêu chí + nhận xét + danh sách từ phát âm sai; lỗi LLM vào DLQ và retry được |
